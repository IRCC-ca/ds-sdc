# Contributor Covenant Code of Conduct for the IRCC DS-SDC project

([Français](#Code-de-conduite-pour-le-projet-nom-du-projet))

Contributors to repositories hosted in IRCC DS-SDC are expected to follow the Contributor Covenant Code of Conduct, and those working within Government are also expected to follow the Values and Ethics Code for the Public Sector
...
This Code of Conduct applies both within project spaces and in public spaces when an individual is representing the project, members or IRCC.
Examples of representing a project, members or IRCC include using an official project e-mail address, posting via an official social media account, or acting as an appointed representative at an online or offline event.
...
# Code de conduite pour le projet IRCC DS-SDC
<!--markdownlint-enable MD025-->

([English](#Contributor-Covenant-Code-of-Conduct-for-the-projectname-project))

Les contributeurs aux dépôts hébergés dans IRCC DS-SDC sont tenus de respecter le Code de conduite du Pacte des contributeurs, et ceux qui travaillent au sein du gouvernement sont également tenus de respecter le Code de valeurs et d'éthique du secteur public.
