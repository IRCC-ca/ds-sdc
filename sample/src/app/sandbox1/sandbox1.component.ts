...
export class Sandbox1Component implements AfterViewInit {
    ...
    @ViewChild("invalidCheckedCheckbox") invalidCheckedCheckbox!:ElementRef<HTMLInputElement>;
    @ViewChild("indeterminateCheckbox") indeterminateCheckbox!:ElementRef<HTMLInputElement>;
    @ViewChild("indeterminateInvalidCheckbox") indeterminateInvalidCheckbox!:ElementRef<HTMLInputElement>;


    @ViewChild("invalidRadio") invalidRadio!: ElementRef<HTMLInputElement>;
    @ViewChild("invalidCheckedRadio") invalidCheckedRadio!:ElementRef<HTMLInputElement>;
    ...
    ngAfterViewInit() {
        ...
        this.invalidCheckedCheckbox.nativeElement.setCustomValidity('invalid field');
        ...
        this.indeterminateInvalidCheckbox.nativeElement.setCustomValidity('invalid field');
        ...
        this.invalidCheckedRadio.nativeElement.setCustomValidity('invalid field');
    }
}
